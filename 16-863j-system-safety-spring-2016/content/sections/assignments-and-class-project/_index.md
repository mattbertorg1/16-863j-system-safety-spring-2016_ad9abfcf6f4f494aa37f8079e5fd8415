...
menu:
  leftnav:
    identifier: d59aa135ec7ab23380485d82099b8f0d
    name: Assignments and Class Project
    weight: 50
title: Assignments and Class Project
type: course
uid: d59aa135ec7ab23380485d82099b8f0d
...
**Assignment 2**: Answer the "[How Safe is Safe Enough?]({{< baseurl >}}/sections/assignments-and-class-project/assignment-2-how-safe-is-safe-enough)"
...
1.  Find at least 2 instances of hindsight bias in the [SBS Tank 731 overflow accident report (PDF)]({{< baseurl >}}/sections/assignments-and-class-project/mit16_863js16_tank_report).
